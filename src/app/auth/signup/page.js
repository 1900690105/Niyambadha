...
export default function CreateFocusAccount() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // 🗄️ Store settings in Firestore under /users/{uid}
                ...
                <div className="mt-4 space-y-4">
                  <div className="flex items-start gap-3">
                    <input
                      type="checkbox"
                      id="blockEntire"
                      checked={formData.blockEntireDomain}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          blockEntireDomain: e.target.checked,
                        })
                      }
                    ...
                    <div>
                      ...
                      >
                        Block entire domain (recommended)
                      </label>
                      <p
                      ...
                      >
                        We&apos;ll block all pages under this domain.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      >
                        Your blocked sites will be stored securely and used by
                        the extension.
                      </p>
                    </div>
                  </div>
